...
class CalculatorBot{
    ...
    static void startCalculator(){
        ...
        do{
            ...
            if(option!=null)
            switch (option){
                case 1: result = (double) calculator.add(num1,num2);break;
                case 2: result = (double) calculator.subtract(num1,num2);break;
                case 3: result = (double) calculator.multiply(num1,num2);break;
                case 4: result = calculator.divide(num1,num2);break;
                case 5: result = calculator.modulus(num1,num2);break;
                default:
...
public class CalculatorEHtask {
    public static void main(String[] args) {
        CalculatorBot.startCalculator();
    }
}
//Cannot invoke "java.lang.Integer.intValue()" because the return value of "coreJava9.Calculator.modulus(int, int)" is null
//	at SNVA/coreJava9.CalculatorBot.startCalculator(CalculatorEHtask.java:70)